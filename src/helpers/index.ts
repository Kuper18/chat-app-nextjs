...
export const updateMessages = (queryClient: QueryClient, roomId: number) => (newMessage: TMessage) => {
...
export const readMessageOnSuccess = (queryClient: QueryClient) => (message: TMessage) => {
